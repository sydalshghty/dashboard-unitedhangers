...
function EditSize() {
    ...
    const getSizeOnly = () => {
        try {
            authFetch(`https://united-hanger-2025.up.railway.app//api/sizes/${SizeID}`, {
                method: "GET",
                headers: {
    ...
    const PutSize = async () => {
        ...
        try {
            await authFetch(`https://united-hanger-2025.up.railway.app//api/sizes/${SizeID}`, {
                method: "PUT",
                headers: {
                    "Authorization": `Bearer ${token}`
                },
            ...
            {!size ? <Loading /> :
                <>
                    ...
                    <div className="col-Delete-Edit">
                        <button className="delete" onClick={handleNavigate}>Delete</button>
