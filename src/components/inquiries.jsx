                ...
                :
                    <>
                        {Inquiries.map((inquiry,index) => {
                            return(
                                <Link to={`/inquiries/${inquiry.id}`} style={{textDecoration: "none"}}>
                                    <div className="Col-Inquiriey" style={{backgroundColor: backgroundProduct(`${inquiry.id}`)}} key={inquiry.id}>
                                        <p className="P-Id">{inquiry.id}</p>
